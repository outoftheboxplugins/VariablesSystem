...
{
	FString VariableClassString;
	VariableName.ToString(VariableClassString);
	...
	case EGenericVariablesNodeError::InstancedMissingOwner:
		{
			CompilerContext.MessageLog.Error(
				*LOCTEXT("CustomNodeFailedInstancedOwner", "[VariablesSystem] Instanced variables must have an owner, please conect a pin or set a default value").ToString(), this
			);
