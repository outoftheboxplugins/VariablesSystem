...
#include "VariablesSystemFactoryNew.h"
...
UVariablesSystemFactoryNew::UVariablesSystemFactoryNew(const FObjectInitializer& ObjectInitializer)
...
bool UVariablesSystemFactoryNew::ShouldShowInNewMenu() const
{
	return true;
}

UObject* UVariablesSystemFactoryNew::FactoryCreateFile(UClass* InClass, UObject* InParent, FName InName, EObjectFlags Flags, const FString& Filename, const TCHAR* Parms, FFeedbackContext* Warn, bool& bOutOperationCanceled)
{
...
bool UVariablesSystemFactoryNew::ConfigureProperties()
{
...
UObject* UVariablesSystemFactoryNew::FactoryCreateNew(UClass* Class, UObject* InParent, FName Name, EObjectFlags Flags, UObject* Context, FFeedbackContext* Warn)
{
